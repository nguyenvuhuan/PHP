...
{
if ($b==0)
$nghiem="Phuong trình có vô s? nghi?m";
if ($b<>0)
$nghiem="Phuong trình vô nghi?m";
}
else 
{
$x= -($b/$a);
...
<tr>
<td colspan="3" bgcolor="#336699"><strong>Gi?i phuong trình b?c 1 </strong></td>
</tr>
<tr>
<td width="120">Phuong trình </td>
<td width="250">
